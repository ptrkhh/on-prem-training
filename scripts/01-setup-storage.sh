...
echo "  2. Run ./02-setup-gdrive-shared.sh to mount the Google Drive Shared Drive at /shared (required)"
echo "  3. Run ./04-setup-users.sh to create user accounts"
echo ""
echo "Note: The /shared directory must mirror the Google Drive Workspace Shared Drive so datasets and collaboration assets are protected in backups."
echo "  Run ./02-setup-gdrive-shared.sh to configure and mount it before continuing."
echo ""
