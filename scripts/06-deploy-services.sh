...
echo "    Username: admin"
echo "    Password: Set in config.sh (GRAFANA_ADMIN_PASSWORD)"
...
echo "    Username: admin"
echo "    Password: Set in config.sh (PORTAINER_ADMIN_PASSWORD)"
echo "    Note: Automatically initialized on first deployment"
